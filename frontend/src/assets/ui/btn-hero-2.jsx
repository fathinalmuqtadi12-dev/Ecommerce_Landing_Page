...
function BtnHero2() {
  return (
    <motion.button
      className="px-3 sm:px-4 py-2 bg-white rounded-2xl border border-gray-300 relative overflow-hidden group text-xs sm:text-sm md:text-base"
      whileHover={{ scale: 1.05, borderColor: "#000" }}
      whileTap={{ scale: 0.95, borderColor: "#000" }}
    >
      <div className="flex flex-row items-center gap-2 h-full">
        <motion.img
          src="/src/assets/resources/icon/user-icon.svg"
          alt="login-icon"
